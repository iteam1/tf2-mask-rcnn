...
IMGS_PATH = "debug" #  PATH TO IMAGES
MODEL_PATH = "inference_graph/frozen_inference_graph.pb" # PATH TO MODEL FILE frozen_inference_graph.pb
LABEL_PATH = "dataset/model1_val/label_map.pbtxt" # PATH TO LABEL MAP FILE labelmap.pbtxt
